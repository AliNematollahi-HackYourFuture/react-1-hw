...
const API_KEY = "c1pJyDpvkjhRIPHCDeI9tIXMVu5WnJSv2MKkSrIg";
          ...
          {roverPhoto?.photos?.length ? (
            <>
              ...
              {roverPhoto?.photos.map((photo) => {
                return <RoverPhoto key={photo.id} src={photo.img_src} date={photo.earth_date} roverName={photo.rover.name} />;
              })}
            </>
          ) : (
